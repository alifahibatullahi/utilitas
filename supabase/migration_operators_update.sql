...
-- 3. Insert 52 personil — susunan Mei 2026
-- Perubahan: Sandhy Yudha P (baru, Supervisor Group D), rotasi jabatan Foreman antar grup
...
('Yudistira Alnur',       'group_a', 'A', '2125525', 'Foreman Turbin', 'UBB'),
('Aldilla Indra R',       'group_a', 'A', '2180323', NULL, 'UBB'),
('Rizky Dharmaji',        'group_a', 'A', '2156352', 'Foreman Boiler', 'UBB'),
('Jaka Riyantaka',        'group_a', 'A', '2146101', NULL, 'UBB'),
...
('Ferdian Maulana Fah',  'group_b', 'B', '2125676', 'Foreman Turbin', 'UBB'),
('Mohamad Rizky Arsyi',  'group_b', 'B', '2180310', NULL, 'UBB'),
('Yusuf Efendi Saputra', 'group_b', 'B', '2156361', 'Foreman Boiler', 'UBB'),
('Rachmat Nordiyansyah', 'group_b', 'B', '2146117', NULL, 'UBB'),
('Nastainul Firdaus Z',  'group_b', 'B', '2146089', NULL, 'UBB'),
('Bili Pratama Kurnia',  'group_b', 'B', '2146080', NULL, 'UBB'),
...
('Muhammad Indra Ali',   'group_c', 'C', '2156337', 'Foreman Boiler', 'UBB'),
('Dimas Cahyo Nugroho',  'group_c', 'C', '2180302', NULL, 'UBB'),
('Rizqy Aulia Rahman',   'group_c', 'C', '2156353', NULL, 'UBB'),
('Akhmad Agung Prabowo', 'group_c', 'C', '2156285', NULL, 'UBB'),
...
-- ─── Group D — Organik (UBB) — Sandhy Yudha P masuk Mei 2026 ───
('Sandhy Yudha P',       'group_d', 'D', '2084983', 'Supervisor', 'UBB'),
('Ade Rahmad Abrianto',  'group_d', 'D', '2125719', 'Foreman Turbin', 'UBB'),
('Moh. Taufiqurrohman',  'group_d', 'D', '2146088', NULL, 'UBB'),
('Ilham Mirza Nur R',    'group_d', 'D', '2146074', NULL, 'UBB'),
('Ahmad Shofi Hamim',    'group_d', 'D', '2156283', 'Foreman Boiler', 'UBB'),
('Alifahi Batullahi',    'group_d', 'D', '2180331', NULL, 'UBB'),
('Julio Purnanugraha',   'group_d', 'D', '2146090', NULL, 'UBB'),
