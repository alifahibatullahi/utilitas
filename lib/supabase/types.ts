...
// ─── Extended Shift Tables (from Google Sheets migration) ───
...
export interface ShiftWaterQualityRow {
    ...
    demin_xtra_ph: number | null;
    demin_xtra_conduct: number | null;
    demin_xtra_sio2: number | null;
    created_at: string;
}

// ─── Extended Daily Report Tables ───
