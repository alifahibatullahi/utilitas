...
const STATUS_CONFIG: Record<CriticalStatus, { label: string; bg: string; text: string; icon: string }> = {
    OPEN: { label: 'OPEN', bg: 'bg-rose-500/15', text: 'text-rose-500', icon: 'info' },
    IP: { label: 'IN PROGRESS', bg: 'bg-amber-500/15', text: 'text-amber-500', icon: 'pending' },
    OK: { label: 'SELESAI', bg: 'bg-slate-600/15', text: 'text-slate-600', icon: 'check_circle' },
    CLOSED: { label: 'SELESAI', bg: 'bg-slate-600/15', text: 'text-slate-600', icon: 'lock' },
};
...
const STATUS_CONFIG_LIGHT: Record<CriticalStatus, { label: string; bg: string; text: string; icon: string }> = {
    ...
    OK: { label: 'SELESAI', bg: 'bg-white border border-slate-300', text: 'text-slate-600', icon: 'check_circle' },
    CLOSED: { label: 'SELESAI', bg: 'bg-white border border-slate-300', text: 'text-slate-600', icon: 'lock' },
};

// Solid theme variant
const STATUS_CONFIG_SOLID: Record<CriticalStatus, { label: string; bg: string; text: string; icon: string }> = {
    OPEN: { label: 'OPEN', bg: 'bg-rose-500', text: 'text-white', icon: 'error' },
    IP: { label: 'IN PROGRESS', bg: 'bg-amber-500', text: 'text-white', icon: 'pending' },
    OK: { label: 'SELESAI', bg: 'bg-slate-600', text: 'text-white', icon: 'check_circle' },
    CLOSED: { label: 'SELESAI', bg: 'bg-slate-600', text: 'text-white', icon: 'lock' },
};
