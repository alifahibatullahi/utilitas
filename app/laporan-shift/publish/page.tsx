...
/** Halaman Review/Publish laporan shift (full-screen, punya URL sendiri).
 *  Metadata laporan dibawa lewat query: id, date, shift, group, sup, ft, fb. */
function PublishShiftInner() {
    ...
    const foremanTurbin = sp.get('ft') ?? '';
    const foremanBoiler = sp.get('fb') ?? '';
