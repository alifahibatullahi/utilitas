...
export default function WorkOrderDetailModal({
    ...
    const accentLightBg = isPreventif ? 'bg-emerald-50' : 'bg-violet-50';
    const accentLightBorder = isPreventif ? 'border-emerald-100' : 'border-violet-100';
                        ...
                        <div className="bg-white border border-slate-200/60 rounded-2xl shadow-sm p-5 flex flex-col md:flex-row md:items-center justify-between gap-6 divide-y md:divide-y-0 md:divide-x divide-slate-150">
                            ...
                            <div className="flex-1 md:pr-6 flex items-center gap-4">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <span className="text-sm font-black text-slate-800 whitespace-nowrap">{formatDate(workOrder.date)}</span>
                                </div>
                            </div>
                            ...
                            <div className="flex-[3] md:px-6 py-4 md:py-0 flex items-center gap-4">
                                ...
                                <div className="min-w-0">
                                    <span className="text-[10px] uppercase font-bold text-slate-400 tracking-wider block mb-0.5">Deskripsi {tipeLabel}</span>
                                    <span className="text-sm md:text-base font-black text-slate-900 leading-relaxed block break-words">{workOrder.deskripsi}</span>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 md:pl-6 pt-4 md:pt-0 flex items-center gap-4">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <span className="text-sm font-black text-slate-800 whitespace-nowrap">{workOrder.notif || '-'}</span>
                                </div>
                            </div>
                        </div>
